    ...
    public class BlogInitializer : DropCreateDatabaseAlways<BlogContext> {
        ...
        protected override void Seed(BlogContext context) {
            ...
            var fans = new List<Fan> {
                ...
                new Fan(3, "Mike", "Laury", new DateTime(1980,8,2), Gender.Male, 7, "admin", "admin", true),
            };
            ...
            var comments = new List<Comment> {
                ...
                new Comment(5, "Comment 5", "Igor", "https://Igor.com", DateTime.Today, "fifth comment ever", 4),
                new Comment(6, "Comment 6", "Igor", "https://Igor.com", DateTime.Today, "sixth comment ever", 5)

            };

            var posts = new List<Post> {
                new Post(1, "Post 1", "Liron", "https://Liron.com", DateTime.Today, "First post ever", "images/flower.png", "", comments.FindAll(x => x.ID < 3), new List<Tag> { tags[0], tags[1] }),
                ...
                new Post(3, "Post 3", "Yakir", "https://Yakir.com", DateTime.Today.AddDays(-3), "third post ever", "", "", comments.FindAll(x => x.ID == 4), new List<Tag> { tags[0] }),
                ...
                new Post(5, "Post 5", "Yakir", "https://Yakir.com", DateTime.Today.AddDays(-3), "fifth post ever", "", "", comments.FindAll(x => x.ID == 6), tags)
            };
